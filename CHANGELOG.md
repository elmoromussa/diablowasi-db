...
|---|---|---|
| 1.2.0 | 2026-09-16 | Taules de corpus i riquesa per tipologia per al capítol 4 de la memòria (`analysis/scripts/05_taules_cap4.R`, `resultats_pas3.txt` i les taules corresponents). Cap canvi d'esquema ni de dades. |
